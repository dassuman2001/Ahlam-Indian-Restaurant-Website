...
const Footer: React.FC = () => {
  return (
    <footer className="bg-charcoal-950 text-stone-400 border-t border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center md:text-left">
          ...
          <div className="space-y-4">
            <h3 className="text-sm font-bold text-white uppercase tracking-widest mb-4">Visit Us</h3>
            ...
            <div className="flex items-center justify-center md:justify-start pt-2">
              <span className="text-gold-accent font-serif text-lg">{RESTAURANT_DETAILS.phone}</span>
            </div>
          </div>

          {/* Hours */}
          <div className="space-y-4">
            <h3 className="text-sm font-bold text-white uppercase tracking-widest mb-4">Opening Hours</h3>
            ...
            <div className="pt-6 flex justify-center md:justify-start space-x-6">
                 <a href={RESTAURANT_DETAILS.instagramUrl} className="text-stone-500 hover:text-gold-accent transition-colors">
                    <Instagram size={20} />
                 </a>
            </div>
          </div>
        ...
        <div className="mt-16 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center text-xs text-stone-600">
          <p>&copy; {new Date().getFullYear()} Ahlam Restaurant. All rights reserved.</p>
          <div className="mt-4 md:mt-0 space-x-6">
            <a href="#/admin" className="hover:text-stone-400 transition-colors">Admin Login</a>
